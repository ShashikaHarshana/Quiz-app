    ...
    <div className='tutorial-home'>
        ...
        <div className='code-example-container'>
          <div className={`code-ex-code ${isDark? 'dark' : 'light'}`}>
            ...
            &emsp;&emsp;&emsp;&emsp;<span style={{color:'#3bc9b0'}}>System</span>.<span style={{color:'#4a9cd6'}}>out</span>.<span style={{color:'#dcb862'}}>println</span>(<span style={{color:'#c3602d'}}>"Hello World"</span>); <br/>
            &emsp;&emsp; &#125; <br/>
            &#125;
          </div>
