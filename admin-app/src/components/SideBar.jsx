...
import { Badge, Button, Modal, p } from "@nextui-org/react";
    ...
    <div className={`${isDark ? "dark" : ""}`}>
      <div className="sidebar-container">
        <div className="logo-container">
          <Badge disableOutline color="primary" content="Admin" size="xs">
        ...
        <div className="navigation-tabs">
          <a href="/dashboard">
            ...
            >
              <Icon height={20} icon="material-symbols:dashboard" />
              &nbsp; Dashboard
            </div>
          </a>
          ...
          <a href="/tutorials">
            ...
            >
              <Icon height={20} icon="fluent:learning-app-24-filled" />
              &nbsp; Tutorials
            </div>
          </a>
          ...
          <a href="/quizzes">
            ...
            >
              <Icon height={20} icon="material-symbols:quiz" />
              &nbsp; Quizzes
            </div>
          </a>
          ...
          <a href="/challenges">
            <div
              className={`tab ${
                activeTab === "challenges" ? "active-tab" : ""
              }`}
              onClick={() => setActiveTab("challenges")}
            >
              <Icon height={20} icon="carbon:share-knowledge" />
              &nbsp; Challenges
            </div>
          </a>
        </div>
        ...
        <div style={{ padding: "5px 15px" }}>
          ...
          <div className="tab-danger" onClick={() => setIsLogoutOpen(true)}>
            <Icon height={20} icon="material-symbols:logout" />
            &nbsp; Logout
          </div>
        </div>
      </div>
      <div className="icon-sidebar-container"></div>
