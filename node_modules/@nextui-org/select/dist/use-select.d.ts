...
import * as _nextui_org_use_aria_multiselect_src_use_multiselect_state from '@nextui-org/use-aria-multiselect/src/use-multiselect-state';
...
type UseSelectProps<T> = Omit<Props<T>, keyof MultiSelectProps<T>> & MultiSelectProps<T> & CollectionProps<T> & SelectVariantProps;
declare function useSelect<T extends object>(originalProps: UseSelectProps<T>): {
    ...
    state: _nextui_org_use_aria_multiselect_src_use_multiselect_state.MultiSelectState<T>;
    label: ReactNode;
